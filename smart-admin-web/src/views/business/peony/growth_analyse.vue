  ...
  <div>
    <Card class="smart-query-card">
      ...
      <Row class="smart-query-form-row">
        <span>
          创建时间: <DatePicker placeholder="选择日期" split-panels style="width: 200px" type="date" v-model="queryForm.selectTime"/>
        </span>
        <span>
            ...
            children: [
              {
                ...
                align: 'center',
                render:(h, params) =>{
                  return h("span", {}, params.row.this_day_data.d_sum);
                }
              },
              {
                title: '汽油',
                ...
                children: [
                  {
                    ...
                    align: 'center',
                    render:(h, params) =>{
                      return h("span", {}, params.row.this_day_data.q_sum);
                    }
                  },
                  {
                    title: '92#',
                    ...
                    align: 'center',
                    render:(h, params) =>{
                      return h("span", {}, params.row.this_day_data.oil_92);
                    }
                  },
                  {
                    title: '95#',
                    ...
                    align: 'center',
                    render:(h, params) =>{
                      return h("span", {}, params.row.this_day_data.oil_95);
                    }
                  },
                  {
                    title: '98#',
                    ...
                    align: 'center',
                    render:(h, params) =>{
                      return h("span", {}, params.row.this_day_data.oil_98);
                    }
                  }
                ]
              },
                ...
                children: [
                  {
                    ...
                    align: 'center',
                    render:(h, params) =>{
                      return h("span", {}, params.row.this_day_data.c_sum);
                    }
                  },
                  {
                    title: '0#',
                    ...
                    align: 'center',
                    render:(h, params) =>{
                      return h("span", {}, params.row.this_day_data.oil_0);
                    }
                  }
                ]
              }
